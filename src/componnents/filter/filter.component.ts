...
@Component({
  selector: 'app-filter',
  standalone: true,
  imports: [FormsModule , RouterOutlet, CurrencyPipe, RouterLink , NgClass],
...
export class FilterComponent {
  ...
  // פונקציה להבאת כל המוצרים, הקטגוריות והחברות
  getAllProducts(){
  ...
  filterProducts() {
    ...
    this.productService.getByFilter(this.filterCriteria).subscribe(
      filteredProducts => {
